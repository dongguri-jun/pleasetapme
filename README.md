...
테스트 완료 후 NFC 태그를 보호하는 것을 권장합니다. 두 가지 방법이 있습니다.

#### 암호 설정 (권장)

비밀번호를 설정하면 비밀번호 없이는 태그를 수정할 수 없습니다. 나중에 Lightning Address를 변경해야 할 때 비밀번호로 해제 후 다시 기록할 수 있습니다.

- **Android**: NFC Tools → Other → **암호 설정**
- **iOS**: NFC Tools → Other → **암호 설정**

#### 태그 잠금 (영구)

태그를 영구적으로 잠급니다. 한번 잠그면 되돌릴 수 없습니다.

- **Android**: NFC Tools → Other → **잠금 태그**
- **iOS**: NFC Tools → Other → **태그 잠그기**

> **주의: 태그 잠금은 되돌릴 수 없습니다.** 반드시 테스트를 완료한 후에 잠그세요. 주소 변경 가능성이 있다면 암호 설정을 권장합니다.
