...
웹 런처 페이지 완성. 3개 뷰(랜딩/셋업/결제), 지갑 선택 UI(WoS/Phoenix/Blink/Zeus/Other), QR 코드(qrcode-generator CDN), 주소 복사, OS 감지 자동 리디렉트, 다크모드, 접근성(ARIA), OG 메타태그, 에러 처리 모두 구현됨.
